...
public class ViewPagerOptions {
    ...
    public var tabViewTextHighlightFont:UIFont?
    ...
    public var tabViewMarginTop:CGFloat = 0 // TODO: 目前還沒有作用
    public var tabViewMarginBottom:CGFloat = 0
    public var tabViewMarginLeft:CGFloat = 0
    public var tabViewMarginRight:CGFloat = 0
    public var tabViewSpacing:CGFloat = 8.0
    public var tabViewEdgeInsets:CGFloat = 16.0
    
    // Tab Indicator
    public var tabIndicatorViewWidth:CGFloat = -1
